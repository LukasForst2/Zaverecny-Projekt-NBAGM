...
export class Team {
    ...
    _salaryCap = 9185000000; //cap 180M aby byla simulace balancovana, readonly aby nesel menit
    constructor(name) {
        this._name = name;
    }
    get name() {
...
if (luka)
    teamA.addPlayer(luka);
if (sga)
    teamA.addPlayer(sga);
if (brown)
    teamA.addPlayer(brown);
if (pwat)
    teamA.addPlayer(pwat);
if (embiid)
    teamA.addPlayer(embiid);
